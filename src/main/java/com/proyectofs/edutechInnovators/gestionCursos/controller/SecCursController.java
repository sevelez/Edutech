package com.proyectofs.edutechInnovators.gestionCursos.controller;

import com.proyectofs.edutechInnovators.gestionCursos.entity.Seccion;
import com.proyectofs.edutechInnovators.gestionCursos.entity.Curso;
import com.proyectofs.edutechInnovators.gestionCursos.services.SeccionService;
import com.proyectofs.edutechInnovators.gestionCursos.services.CursoService;
...
@RestController
@RequestMapping("/api")
public class SecCursController {

    private final SeccionService seccionService;
    private final CursoService cursoService;

    @Autowired
    public SecCursController(SeccionService seccionService, CursoService cursoService) {
    ...
    public ResponseEntity<Seccion> createSeccion(@RequestBody Seccion seccion) {
        try {
            ...
            return ResponseEntity.badRequest().body(null); // O un objeto de error más detallado
    ...
    public ResponseEntity<Map<String, Object>> asignarDocenteASeccion(
        ...
        // Validar que seccionId y docenteId existan, y que la fecha sea válida.
        try {
