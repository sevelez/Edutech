package com.proyectofs.edutechInnovators.gestionCursos.services;
...
import com.proyectofs.edutechInnovators.gestionCursos.repository.SeccionRepository;
import com.proyectofs.edutechInnovators.gestionCursos.repository.SeccionDocenteRepository;
...
public class SeccionServiceImpl implements SeccionService {
    ...
    public void asignarDocenteASeccion(Long seccionId, Long docenteId, String fechaContrato) throws Exception {
        ...
        seccionDocente.setSeccionId(seccionId);
        seccionDocente.setDocenteId(docenteId);
        seccionDocente.setFechaContrato(fechaContratoDate);
